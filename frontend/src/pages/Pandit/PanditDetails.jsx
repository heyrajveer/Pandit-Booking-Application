    ...
    <div className="container mt-5">
      <div className="row">
        ...
        <div className="col-md-5">
          <img
            src={pandit.image || "https://cdn.vectorstock.com/i/1000v/84/24/indian-pandit-cartoon-vector-35888424.jpg"}
            alt="pandit"
            className="img-fluid rounded shadow"
            style={{ height: "380px", objectFit: "cover", width: "100%", objectPosition:"top" }}
          />
        </div>
